...
- firstly, we always announce every success or failure to user through color printing with 'typer.secho'
...
- if menu version is used :
	we never raise exceptions, and we return True for success and False for failure, sub function is exited and user can retry starting from main menu.
"""
